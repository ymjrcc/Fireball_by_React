    ...
    render(){
        return (
            <div className={style.questions}>
                ...
                <QueItem q="0" toggleAns={this.toggleAns.bind(this)}>火球的商品从哪里发货？</QueItem>             
                <AnsItem a="0" show={this.state.a0}>
                    多仓直发：每个买手有多个合作商家，发货地点根据商家不同而改变。
                </AnsItem>

                <QueItem q="1" toggleAns={this.toggleAns.bind(this)}>如何修改地址/电话？</QueItem>
                <AnsItem a="1" show={this.state.a1}>
                    快递公司的系统不支持修改收货地址和电话，建议您找朋友或家人代收。若有特殊情况，请联系在线客服。
                </AnsItem>

                <QueItem q="2" toggleAns={this.toggleAns.bind(this)}>什么时候发货？</QueItem>
                <AnsItem a="2" show={this.state.a2}>
                    可参考商品详情页底部标注的预计发货时间。预售商品及海外代购商品发货时间会有相应延长。
                </AnsItem>

                <QueItem q="3" toggleAns={this.toggleAns.bind(this)}>如何办理退换货？</QueItem>
                <AnsItem a="3" show={this.state.a3}>
                    在“我的订单”页面，选择需要退/换货的订单，找到底部“退/换货”按钮申请售后。收货7天后的订单无法再发起售后。
                </AnsItem>
                
                <QueItem q="4" toggleAns={this.toggleAns.bind(this)}>退款多久可以收到？</QueItem>
